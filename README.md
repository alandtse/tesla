...
1. Use [HACS](http://web.archive.org/web/20240731205928/https://hacs.xyz/docs/setup/download/), in `HACS > Integrations > Explore & Add Repositories` search for "Tesla". After adding this `https://github.com/alandtse/tesla` as a custom repository. Skip to 7.
